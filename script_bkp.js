...
function startGame() {
  ...
  if (gameMode === 'timed') {
    ...
    document.getElementById('timer').style.display = 'none'; // Hide timer for practice mode
  }

  generateQuestion(difficulty);
  clearFeedback(); // Now this function is defined
}
...
function clearFeedback() {
  ...
  feedbackElement.className = 'feedback'; // Reset feedback styling
}
...
function checkAnswer() {
  ...
  if (userAnswer === currentAnswer) {
    ...
    document.getElementById('feedback').className = 'feedback correct'; // Apply correct styling
    ...
    document.getElementById('feedback').className = 'feedback incorrect'; // Apply incorrect styling
...
function nextQuestion() {
  const difficulty = document.getElementById('difficulty-level').value;
  generateQuestion(difficulty);
  clearFeedback(); // Clear feedback for the next question
}
